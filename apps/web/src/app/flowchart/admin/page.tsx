        ...
        >
          <div className={hstack({ justify: 'space-between', alignItems: 'center' })}>
            <div>
              ...
              >
                Manage the skill sequences that determine what students learn and in what order.
                Changes here affect all students' practice recommendations.
              </p>
            </div>
            <Link
              href="/flowchart"
          ...
          >
            ...
            >
              ...
              <TaxonomyBrowserInline
                key={`taxonomy-${refreshKey}`}
                onRegenerateComplete={handleRefresh}
              />
            </div>
            ...
            >
              ...
              <EmbeddingsManagerInline
                key={`embeddings-${refreshKey}`}
...
function EmbeddingsManagerInline({ onComplete }: { onComplete?: () => void }) {
  ...
  return (
    <div className={vstack({ gap: '3', alignItems: 'stretch' })}>
      ...
      >
        <div>
          Model: <code>text-embedding-3-large</code>
        </div>
        <div>
          Version: <code>{EMBEDDING_VERSION}</code>
        </div>
      </div>
