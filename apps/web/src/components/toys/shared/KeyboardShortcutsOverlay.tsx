 ...
 */
export function KeyboardShortcutsOverlay({ shortcuts, onClose, isDark }: KeyboardShortcutsOverlayProps) {
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          ...
          <button
            ...
            style={{
              ...
              color: isDark ? '#94a3b8' : '#64748b', fontSize: 20, lineHeight: 1, padding: '2px 6px',
            }}
          >
            &times;
          </button>
        ...
        {shortcuts.map(({ key, description }) => (
          <div key={key} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '5px 0' }}>
            ...
            <span style={{ fontSize: 13, color: isDark ? '#94a3b8' : '#64748b', marginLeft: 12 }}>{description}</span>
          </div>
        ))}
      </div>
    </div>
