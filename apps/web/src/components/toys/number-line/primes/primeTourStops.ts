...
export const PRIME_TOUR_STOPS: PrimeTourStop[] = [
  {
    ...
    blurb:
      'Every number has a secret color inside! The color comes from its smallest building block.',
    ttsText:
  ...
  },
  {
    ...
    blurb:
      "Some numbers are like super-strong LEGOs. You can't break them into smaller equal piles!",
    ttsText:
    ...
    ttsTone:
      'Playful challenge, then a eureka moment. Like daring them to try a fun puzzle, then revealing the answer.',
    hoverValue: 7,
    highlightValues: [7],
    dimOthers: 0.4,
    minDwellMs: 2000,
  ...
  },
  {
    ...
    blurb:
      "Some primes are best friends — they're called twins because they're only two steps apart.",
    ttsText:
    ...
    ttsTone:
      'Delighted discovery. Like spotting something rare on a nature walk and pointing it out with glee.',
    hoverValue: 11,
  ...
  },
  {
    ...
    ttsTone:
      'Mischievous and amazed. Like revealing a magic trick the listener can try themselves.',
    hoverValue: 131,
    highlightValues: [131],
    dimOthers: 0.4,
    minDwellMs: 2000,
  ...
  },
  {
    ...
    blurb:
      'As we fly farther out, the primes get lonelier. But they never, ever disappear completely.',
    ttsText:
    ...
    ttsTone:
      'Hushed, floating awe. Like drifting through deep space, pointing out distant beautiful stars.',
    minDwellMs: 3000,
    autoAdvance: true,
  },
  {
    ...
    blurb:
      'This is a Mersenne prime — a true giant, made from a special recipe using only the number 2.',
    ttsText:
    ...
    ttsTone:
      "Breathless excitement. Like describing a T-Rex skeleton or the world's tallest roller coaster.",
    hoverValue: 8191,
  ...
  },
  {
    ...
    ttsTone:
      'Conspiratorial whisper, building to warm genuine encouragement. Like entrusting them with a precious secret map.',
    hoverValue: 29,
