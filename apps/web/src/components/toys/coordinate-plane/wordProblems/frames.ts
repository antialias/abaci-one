...
const pizzaShop: SemanticFrame = {
  ...
  subjectPhrases: ['Sonia', 'She', 'A customer'],
  emoji: '🍕',
...
const plantGrowth: SemanticFrame = {
  ...
  subjectPhrases: ['The plant', 'It', 'The sunflower'],
  emoji: '🌱',
...
const roadTrip: SemanticFrame = {
  ...
  subjectPhrases: ['The car', 'They', 'The family'],
  emoji: '🚗',
...
const baking: SemanticFrame = {
  ...
  subjectPhrases: ['Each batch', 'The recipe', 'She'],
  emoji: '🧁',
  supportedLevels: [1, 2, 3],
}
...
const braceletMaking: SemanticFrame = {
  ...
  subjectPhrases: ['Each bracelet', 'She', 'A bracelet'],
  emoji: '📿',
  supportedLevels: [1, 2, 3, 4],
}
