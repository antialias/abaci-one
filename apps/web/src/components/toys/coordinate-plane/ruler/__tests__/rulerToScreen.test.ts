...
describe('rulerToScreen', () => {
  ...
  it('converts ruler world coords to screen coords', () => {
    const info = rulerToScreen({ ax: 0, ay: 0, bx: 1, by: 0 }, defaultState, 800, 600)
  ...
  it('computes midpoint', () => {
    const info = rulerToScreen({ ax: -1, ay: 0, bx: 1, by: 0 }, defaultState, 800, 600)
  ...
  it('computes angle for vertical ruler (positive Y → upward on screen)', () => {
    const info = rulerToScreen({ ax: 0, ay: 0, bx: 0, by: 1 }, defaultState, 800, 600)
  ...
  it('handles non-origin center', () => {
    ...
    const info = rulerToScreen({ ax: 5, ay: 5, bx: 6, by: 5 }, state, 800, 600)
  ...
  it('handles independent X/Y scale', () => {
    ...
    const info = rulerToScreen({ ax: 0, ay: 0, bx: 1, by: 1 }, state, 800, 600)
  ...
  it('returns zero length for degenerate ruler', () => {
    const info = rulerToScreen({ ax: 3, ay: 2, bx: 3, by: 2 }, defaultState, 800, 600)
