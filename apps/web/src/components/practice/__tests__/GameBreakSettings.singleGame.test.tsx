...
describe('GameBreakSettings - Single Game Mode', () => {
  ...
  it('should show "Starts automatically between parts" helper text', () => {
    ...
    expect(screen.getByText('Starts automatically between parts')).toBeInTheDocument()
  })
  ...
  it('should NOT show game selection dropdown', () => {
    ...
    expect(document.querySelector('[data-element="game-select-trigger"]')).not.toBeInTheDocument()
  ...
  it('should hide game info and duration when disabled', () => {
    ...
    expect(screen.queryByText('More games coming soon!')).not.toBeInTheDocument()
  })
