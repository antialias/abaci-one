...
export function GameBreakCustomConfig() {
  ...
  return (
    <div data-element="game-break-customize" className={css({ marginTop: '0.375rem' })}>
        ...
        >
          {editableFields.map(([fieldKey, defaultValue]) => {
            ...
            return (
              ...
              >
                <span style={{ color: isDark ? '#9ca3af' : '#6b7280' }}>{fieldKey}</span>
...
function BooleanField({ fieldKey, label, value, onChange, isDark }: BooleanFieldProps) {
  return (
    <div
      data-field={fieldKey}
      className={css({
        ...
        style={{
          backgroundColor: value
            ...
            : isDark
              ...
              : 'rgba(0, 0, 0, 0.08)',
          color: value ? (isDark ? '#86efac' : '#16a34a') : isDark ? '#9ca3af' : '#6b7280',
        }}
      >
        {value ? 'Yes' : 'No'}
      </button>
...
function SelectField({ fieldKey, label, value, options, onChange, isDark }: SelectFieldProps) {
  return (
    <div
      data-field={fieldKey}
      className={css({
    ...
    >
      ...
      <div className={css({ display: 'flex', gap: '0.125rem', flexWrap: 'wrap' })}>
        {options.map((opt) => {
