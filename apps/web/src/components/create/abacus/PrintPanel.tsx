        ...
        <>
          ...
          {supportsWanted && twoStage.ok && twoStageOn && (
            ...
            >
              ...
              directly, and TPU releases from it. Against the plate it is a sparse first layer
              rather than a sheet, so the floor peels off the plate instead of bonding to it.
            </div>
          )}
