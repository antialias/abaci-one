        ...
        <>
          ...
          {twoStageOn && (
            <label
              ...
              style={{
                ...toggleRow(feetOnlyOn),
                alignItems: 'flex-start',
                justifyContent: 'flex-start',
                gap: 8,
                padding: '8px 10px',
                // experimental → amber rather than the accent while it is on
                ...(feetOnlyOn && {
                  background: STUDIO.color.tone.warn.bg,
                  border: `1px solid ${STUDIO.color.tone.warn.bar}`,
                }),
                color: feetOnly.ok ? STUDIO.color.text : STUDIO.color.muted,
