...
export { getVariantSuffix, type ProfileSize, type ProfileTheme, type ProfileState } from '../profile-variants'
 ...
 */
function getDependents(size: ProfileSize, theme: ProfileTheme, state: ProfileState): Array<{ size: ProfileSize; theme: ProfileTheme; state: ProfileState }> {
  ...
  if (size === 'default' && theme === 'default') {
    ...
    deps.push(
      { size, theme: 'light', state: 'idle' },
      { size, theme: 'dark', state: 'idle' },
    )
  }
 ...
 */
function getReferenceVariant(size: ProfileSize, theme: ProfileTheme, state: ProfileState): { size: ProfileSize; theme: ProfileTheme; state: ProfileState } | null {
...
export async function startProfileImageGeneration(
  ...
  return createTask<ProfileImageGenerateInput, ProfileImageGenerateOutput, ProfileImageGenerateEvent>(
