...
export const THATS_RIGHT = audioClip('feedback-thats-right', "That's right! Look at you go!", 'celebration')
...
export const UNSTOPPABLE = audioClip('feedback-unstoppable', 'Un-STOP-able! Nobody can stop you!', 'celebration')
export const LEGENDARY = audioClip('feedback-legendary', 'LEGENDARY! You are a math superstar!', 'celebration')

/** Positive feedback clips to pick from randomly */
export const CELEBRATION_CLIPS = [
  CORRECT, GREAT_JOB, NICE_WORK, KEEP_GOING,
  YOU_GOT_IT, AWESOME, WAY_TO_GO, THATS_RIGHT, HIGH_FIVE,
] as const
